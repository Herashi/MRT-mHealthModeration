...
```{r}
set.seed(0)
d <- rsnmm.R(n = 30, tmax = 30,group_ls = group_all[["30"]], beta1 = c(-0.1, 0, 0, 0),
...
### Generate the simulation dataset with correlation

I think one of the most straightforward way is generating correlated **base** with certain pre-defined working matrix.
...
### Some models (with weights and centered)
