...
```{r echo=FALSE}
load("~/MRT/testing/nobg2-group.RData")
all <- omit

all_10030_wc= subset(all, n ==100 & tmax == 30 & level == '$\\beta_{11}^* = 0.2$')

all_10030_wc[,c("level","group","estc","sec","cpc","g_cp","rmse","sd")] %>% 
...
all_10050_wc[,c("level","group","estc","sec","cpc","g_cp","rmse","sd")] %>% 
...
```{r echo=FALSE}
load("~/MRT/testing/bg2-group.RData")
all <- omit
